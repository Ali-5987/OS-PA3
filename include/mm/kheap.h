...
// the data structure represents a generic heap
// two options, either a free list based implementation
// or a placement based implementation
// (this can be used for early kernel inits)
struct __heap_descriptor {
	free_block_hdr *free_list;     // pointer to the first free block in the heap

    // struct _free_block_hdr *free_list; // pointer to the first free block in the heap
