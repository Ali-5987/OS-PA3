...
static void 	_fat12_8_3to_normal (char* fat_name, char* output);

//! convert a normal string to 8.3 filename
static void 	_fat12_normal_to_8_3 (char* name, char* fat_name);
...
static vnode* 	_fat12_lookup (vnode* dir_node, char* name);
...
void 		_fat12_8_3to_normal (char* fat_name, char* output) {
...
void 		_fat12_normal_to_8_3 (char* name, char* fat_name) {
...
vnode* 		_fat12_lookup (vnode* dir_node, char* name) {
	...
	char fat_name[11];
	_fat12_normal_to_8_3 (name, fat_name);
...
vnode* fat12_open (vnode* node, char* path, uint32_t flags) {
